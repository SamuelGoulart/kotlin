...
class ResultadoImcActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Declarar os coponentes do nosso layout
        ...
        // Exibimos a dica reciperadas no array
